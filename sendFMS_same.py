...
- https://developers.popbill.com/reference/kakaotalk/python/api/send#SendFMS_same
'''

try:
    print("=" * 15 + " 친구톡 이미지 동보 전송 " + "=" * 15)
    ...
    receiptNum = kakaoService.sendFMS_same(CorpNum, plusFriendID, snd, content, altContent,
